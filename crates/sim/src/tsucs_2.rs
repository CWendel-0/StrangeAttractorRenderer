...
const DESCS: &[ParamDesc] = &[
    ...
    ParamDesc { name: "b",  kind: ParamKind::Continuous, min: 0.0, max: 165.0,  default: 55.0  },
    ...
    ParamDesc { name: "dT", kind: ParamKind::Continuous, min: 0.0, max: 0.0003, default: 0.0001 },
];
...
impl Default for Tsucs2 {
    fn default() -> Self { Self::new() }
}

impl Attractor for Tsucs2 {
