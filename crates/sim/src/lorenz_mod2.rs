...
const DESCS: &[ParamDesc] = &[
    ParamDesc { name: "a",  kind: ParamKind::Continuous, min: 0.0,  max: 3.0,  default: 0.9  },
    ParamDesc { name: "b",  kind: ParamKind::Continuous, min: 0.0,  max: 12.0, default: 5.0  },
    ParamDesc { name: "c",  kind: ParamKind::Continuous, min: 0.0,  max: 20.0, default: 9.9  },
    ParamDesc { name: "d",  kind: ParamKind::Continuous, min: 0.0,  max: 3.0,  default: 1.0  },
    ParamDesc { name: "dT", kind: ParamKind::Continuous, min: 0.0,  max: 0.01, default: 0.001},
];

pub struct LorenzMod2 {
    state:  Vec3,
    params: [f32; 5],
}
...
impl Default for LorenzMod2 {
    fn default() -> Self { Self::new() }
}

impl Attractor for LorenzMod2 {
